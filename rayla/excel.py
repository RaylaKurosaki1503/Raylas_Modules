...
if __name__ == '__main__':
    # # C:\Users\rayla\Desktop\test.xlsx
    # # path = input("Enter the path to the file (without quotes): ")
    # path = "C:/Users/rayla/Desktop/test.xlsx"
    # wb = get_workbook(path)
    # # Get the active Worksheet
    # ws = get_active_worksheet(wb)
    # print(ws)
    # # Get the cell values from a Worksheet
    # cell = "A2"
    # print(get_cell_value(ws, cell))
    # # Updating the value of a cell
    # value = "Rayla"
    # update_cell_value(ws, cell, value)
    # print(ws[cell].value)
    # # Print all sheet names
    # print(get_worksheet_names(wb))
    # # Get a specific Worksheet by name
    # ws_name = "Sheet1"
    # ws = get_worksheet(wb, ws_name)
    # print(ws)
    # # Creating a new Worksheet
    # new_sheet_name = "Test"
    # create_new_worksheet(wb, new_sheet_name)
    # print(wb.sheetnames)
    # # Updating the title of a Worksheet
    # ws = wb[new_sheet_name]
    # new_name = "Data"
    # update_worksheet_name(ws, new_name)
    # print(wb.sheetnames)
    # # Adding/Appending Rows
    # lst = ["Rayla", "is", "gorgeous", ":D"]
    # add_data_to_worksheet(ws, lst)
    #
    # # Accessing multiple cells
    # ws = wb["Grades"]
    # # row_max, col_max = get_max_rows(ws), get_max_cols(ws)
    # # for row in ws.iter_rows(1, get_max_rows(ws), 1, get_max_cols(ws), True):
    # #     for value in row:
    # #         print(value)
    # for row in ws.values:
    #     print(row)
